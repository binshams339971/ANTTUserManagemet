...
<section class="page-header-section ptb-40 bg-image" image-overlay="8">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8">
                        <!-- Post-->
                        <article class="post">
                            <div class="post-preview"><img src="https://edublock.co/anttaset/iotcar%281110x512%29.jpg" alt="article" class="img-fluid" /></div>
                            <div class="post-wrapper">
                                <div class="post-header">
                                    <h1 class="post-title">Build your IoT Car with School Of IoT</h1>
                                    <!--<ul class="post-meta">-->
                            ...
                            <h4 class="mt-5 text-primary">Basic Requirement</h4>
                                <div class="d-flex align-items-center mb-3">
                                    <div class="badge-primary-soft rounded p-1">
                                      ...
                                      <p class="mb-0 ml-3">Basic understanding of Arduino</p>
                                </div>
                                <div class="d-flex align-items-center mb-3">
                                    <div class="badge-primary-soft rounded p-1">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                      ...
                                      <p class="mb-0 ml-3">Basic Knowledge of Programming</p>
                                </div>
                            ...
                            <h4 class="mt-5 text-primary">What you’ll learn</h4>
                                <div class="d-flex align-items-center mb-3">
                                      ...
                                      <p class="mb-0 ml-3">Build IoT Car with School Of IoT</p>
                                    </div>
                                    <div class="d-flex align-items-center mb-3">
                                      <div class="badge-primary-soft rounded p-1">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                      ...
                                      <p class="mb-0 ml-3">Assembling various sensors and devices with IoT Car</p>
                                    </div>

                                    <h4 class="mt-5 text-primary">Benefits</h4>
                                <div class="d-flex align-items-center mb-3">
                                      <div class="badge-primary-soft rounded p-1">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                          <polyline points="20 6 9 17 4 12"></polyline>
                                      ...
                                      <p class="mb-0 ml-3">School Of IoT Hardware Setup and Working</p>
                                    </div>
                                    <div class="d-flex align-items-center mb-3">
                                      <div class="badge-primary-soft rounded p-1">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                      ...
                                      <p class="mb-0 ml-3">Designing IoT car  with School Of IoT</p>
                                    </div>
                                                                    
                                     <h4 class="mt-5 text-primary">Course Details: </h4>
                                        <div class="d-flex align-items-center mb-3">
                                              <div class="badge-primary-soft rounded p-1">
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                                  <polyline points="20 6 9 17 4 12"></polyline>
                                              ...
                                              <p class="mb-0 ml-3">Price: BDT 10,000</p>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center mb-3">
                                              ...
                                              <p class="mb-0 ml-3">Total Class: 3 Days (3 Lecture) </p>
                                            </div>
                                            <div class="d-flex align-items-center mb-3">
                                              <div class="badge-primary-soft rounded p-1">
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                              ...
                                              <p class="mb-0 ml-3">Duration: 1.5 Hour/Lecture</p>
                                            </div>
                                            <div class="d-flex align-items-center">
                                              ...
                                              <p class="mb-0 ml-3">Type: Online/Offline + Tools </p>
                                            </div>
                                            <div class="d-flex align-items-center mt-3">
                                              ...
                                              <p class="mb-0 ml-3">Age Group: 10-16 years</p>
                                            </div>
                                        </div>
                        ...
                        <div class="comments-area mb-5">
                          <div class="comment-respond">
                              ...
                              <a class="btn btn-brand-02" href="{{ route('orderform', ['name'=> 'Build your IoT Car with School Of IoT', 'category' => 'Course', 'price' => 10000, 'image' => 'https://edublock.co/anttaset/iotcar%281110x512%29.jpg']) }}">Enroll Now</a>
                          </div>
                      </div>
                        <!-- Comments area end-->
                    </div>
