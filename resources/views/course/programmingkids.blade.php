...
<section class="page-header-section ptb-40 bg-image" image-overlay="8">
        ...
        <div class="module ptb-100">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8">
                        <!-- Post-->
                        <article class="post">
                            <div class="post-preview"><img src="https://edublock.co/anttaset/iot1110x512.jpg" alt="article" class="img-fluid" /></div>
                            <div class="post-wrapper">
                                <div class="post-header">
                                    <h1 class="post-title">Basic Internet of Things (IoT) with School of IoT</h1>
                                    <!--<ul class="post-meta">-->
            ...
            <div class="d-flex align-items-center mb-3">
                  ...
                  <p class="mb-0 ml-3">General concepts of the Internet of Things(IoT) using School of IoT</p>
                </div>
                <div class="d-flex align-items-center mb-3">
                  <div class="badge-primary-soft rounded p-1">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                  ...
                  <p class="mb-0 ml-3">Building blocks of IoT, connection diagram setup, and how they communicate with each other.</p>
                </div>
                <div class="d-flex align-items-center mb-3">
                  <div class="badge-primary-soft rounded p-1">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                  ...
                  <p class="mb-0 ml-3">Assembly of networked devices, programming of networked devices</p>
                </div>
                <div class="d-flex align-items-center mb-3">
                  <div class="badge-primary-soft rounded p-1">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                  ...
                  <p class="mb-0 ml-3">Certificate: YES </p>
                            ...
                            <div class="comments-area mb-5">
                              <div class="comment-respond">
                                  ...
                                  <a class="btn btn-brand-02" href="{{ route('orderform', ['name'=> 'Basic Internet of Things (IoT) with School of IoT', 'category' => 'Course', 'price' => 6700, 'image' => 'https://edublock.co/anttaset/iot1110x512.jpg']) }}">Enroll Now</a>
                              </div>
                          </div>
                            <!-- Comments area end-->
                        </div>
