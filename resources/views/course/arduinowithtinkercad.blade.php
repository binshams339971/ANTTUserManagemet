            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8">
                        <!-- Post-->
                        <article class="post">
                            <div class="post-preview"><img src="https://edublock.co/anttaset/arduinowithtinkercad%281110x512%29.jpg" alt="article" class="img-fluid" /></div>
                            <div class="post-wrapper">
                                <div class="post-header">
                                    <h1 class="post-title">Basic Arduino with Tinkercad</h1>
                                    <!--<ul class="post-meta">-->
                            ...
                            <h4 class="mt-5 text-primary">Basic Requirement</h4>
                                <div class="d-flex align-items-center mb-3">
                                      ...
                                      <p class="mb-0 ml-3">Understanding Basic Physics, Math</p>
                                    </div>
                                    <div class="d-flex align-items-center mb-3">
                                      <div class="badge-primary-soft rounded p-1">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                      ...
                                      <p class="mb-0 ml-3">Basic Scratch Programming</p>
                                    </div>
                            ...
                            <h4 class="mt-5 text-primary">What you’ll learn</h4>
                                <div class="d-flex align-items-center mb-3">
                                      ...
                                      <p class="mb-0 ml-3">Basic Electronics</p>
                                    </div>
                                    <div class="d-flex align-items-center mb-3">
                                      <div class="badge-primary-soft rounded p-1">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                      ...
                                      <p class="mb-0 ml-3">Arduino Programming </p>
                                    </div>
                                    <div class="d-flex align-items-center mb-3">
                                      <div class="badge-primary-soft rounded p-1">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                      ...
                                      <p class="mb-0 ml-3">Tinkercad Circuit Simulation</p>
                                    </div>
                                ...
                                <div class="d-flex align-items-center mb-3">
                                      ...
                                      <p class="mb-0 ml-3">Understanding what is Arduino programming, it's basic concepts, structures, and keywords</p>
                                    </div>
                                    <div class="d-flex align-items-center mb-3">
                                      <div class="badge-primary-soft rounded p-1">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                      ...
                                      <p class="mb-0 ml-3">Learning to Build simple circuits around the Arduino Uno, that implement simple functions</p>
                                    </div>
                                    <div class="d-flex align-items-center mb-3">
                                      <div class="badge-primary-soft rounded p-1">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                      ...
                                      <p class="mb-0 ml-3">Build a Automated Traffic Light</p>
                                    </div>
                                     ...
                                     <h4 class="mt-5 text-primary">Course Details: </h4>
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                              ...
                                              <p class="mb-0 ml-3">Type: Online/Offline </p>
                                            </div>
                                            <div class="d-flex align-items-center mt-3">
                                              ...
                                              <p class="mb-0 ml-3">Age Group: 7-16 years</p>
                                            </div>
                                        </div>
