...
<title>Course | ANTT Robotics Ltd</title>
...
<section class="page-header-section ptb-100 bg-image" image-overlay="8">
            <div class="background-image-wraper" style="background: url('https://edublock.co/anttaset/coursebgw-01.jpg'); opacity: 1;"></div>
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-9 col-lg-7">
                        <div class="page-header-content text-white pt-4">
                            <h1 class="text-white mb-0">STEAM Course </h1>
                            <p class="lead"> Here you can find all your demanded STEAM courses with mind-blowing projects. Robotics, IoT, Block programming and Fourth industrial skills in one station for techenthusiasts<services></services> Explore right now!.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        <div class="sidebar-left pr-4">
                            ...
                            <aside class="widget widget-categories">
                                ...
                                <ul>
                                    <li><a href="#">Scratch Programming<span class="float-right">1</span></a></li>
                                    <li><a href="#">Kids <span class="float-right">3</span></a></li>
                                    <li><a href="#">IOT <span class="float-right">5</span></a></li>
                                    <li><a href="#">Arduino <span class="float-right">2</span></a></li>
                                    <li><a href="#">Electronics <span class="float-right">3</span></a></li>
                                </ul>
                            </aside>
                            ...
                            <aside class="widget widget-categories">
                                ...
                                <form action="#" method="post" class="d-none d-md-block d-lg-block">
                                    ...
                                    <button type="submit" class="btn btn-brand-02 btn-block btn-not-rounded mt-3">Subscribe</button>
                                </form>
                            </aside>
                            ...
                            <aside class="widget widget-tag-cloud">
                                ...
                                <div class="tag-cloud"><a href="#">virtualworkshop</a><a href="#">STEMClub</a><a href="#">programming</a><a href="#">workshop</a><a href="#">Robotics</a><a href="#">IoT</a></div>
                            </aside>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-8">
                        <!-- Post-->
                        <article class="post">
                            <div class="post-preview"><img src="https://edublock.co/anttaset/Robotics%201110x512.jpg" alt="article" class="img-fluid" /></div>
                            <div class="post-wrapper">
                                <div class="post-header">
                                    <h1 class="post-title">Robotics with Arduino</h1>
                                </div>
                                ...
                                <div class="d-flex align-items-center mb-3">
                                      ...
                                      <p class="mb-0 ml-3">Applying Arduino framework in real life)</p>
                                    </div>
                                    <div class="d-flex align-items-center mb-3">
                                      <div class="badge-primary-soft rounded p-1">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                      ...
                                      <p class="mb-0 ml-3">Build functioning circuits on a breadboard</p>
                                    </div>
                                    <div class="d-flex align-items-center mb-3">
                                      <div class="badge-primary-soft rounded p-1">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                      ...
                                      <p class="mb-0 ml-3">Build several science projects using Arduino</p>
                                    </div>
           
                                    
                                  
                                <h4 class="mt-5 text-primary">Short Details </h4>   
                                <p>Arduino is the easiest and productive platform to learn robotics and STEM, nowadays for early age. Arduino platform is easy to use and to create interactive science projects and robots like RC Car, Automated door, Soccer robots.Our course consists of a series of practical problems on making things that work independently: they make their own decisions, act, move, communicate with each other and people around, and control other devices. We will demonstrate how to assemble such devices and programme them using the Arduino platform as a basis.
                                After this course, you will be able to create devices that read the data about the external world with a variety of sensors, receive and forward this data to a PC, the Internet and mobile devices, and control indexing and the movement.
                                </p>
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                      ...
                                      <p class="mb-0 ml-3">Duration: 3 Months, 2 hour/Lecture</p>
                                    </div>
                                    <div class="d-flex align-items-center mb-3">
                                      <div class="badge-primary-soft rounded p-1">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                      ...
                                      <p class="mb-0 ml-3">Number of Lectures: 24</p>
                                    </div>
                                    <div class="d-flex align-items-center">
                                      ...
                                      <p class="mb-0 ml-3">Certificate: YES </p>
                                    </div>
                                </div>
                            </div>
                        </article>
                        <div class="comments-area mb-5">
                          <div class="comment-respond">
                              ...
                              <a class="btn btn-brand-02" href="{{ route('orderform', ['name'=> 'Robotics with Arduino', 'category' => 'Course', 'price' => 8200, 'image' => 'https://edublock.co/anttaset/Robotics%201110x512.jpg']) }}">Enroll Now</a>
                          </div>
                      </div>
                    </div>
                </div>
