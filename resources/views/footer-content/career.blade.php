    ...
    <div class="bg-white rounded-lg shadow py-3 mb-4">
        <div class="col-sm-12 my-4">
            ...
            <ol class="mx-md-5 ml-4 mr-2 text-left" style="list-style-type: decimal;">
                <p class="text-justify text-dark">We believe that engaging with tech has countless personal benefits for kids such as the opportunity to problem-solve, work in teams, explore the underpinnings of the modern world, and bring ideas to life. Hence, we use a well structured method in facilitating our courses in STEM, Robotics, Coding and much more. We make sure of excellent hands-on learning opportunities to help students extend their learning experiences and build confidence.</p>
                <p class="text-justify text-dark">Here you will get the chance to work with amazing team members, mentors, tinkerers, and coders. If you think it's a great fit for you, please check out our current job openings :</p>
            </ol>
        </div>
    </div>
</div>
