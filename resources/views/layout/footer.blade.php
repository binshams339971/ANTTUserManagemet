                ...
                <div class="col-md-12 col-lg-8">
                    <div class="row mt-0">
                        ...
                        <div class="col-sm-6 col-md-3 col-lg-3 mb-4 mb-sm-4 mb-md-0 mb-lg-0">
                            ...
                            <ul>
                                <li>
                                    <a href="#">STEAM Robotics Tools</a>
                                </li>
                                <li>
                                    <a href="#">Learning Management for School</a>
                                </li>
                                <li>
                                    <a href="#">STEAM Robots for School</a>
                                </li>
                                <li>
                        ...
                        <div class="col-sm-6 col-md-3 col-lg-3 mb-4 mb-sm-4 mb-md-0 mb-lg-0">
                            <h6 class="text-uppercase">Industrial Products</h6>
                            <ul>
                                <li>
                                    <a href="#">Industrial IoT Solutions</a>
                                </li>
                                <li>
                                    <a href="#">IoT Products for Automation</a>
                                </li>
                                <li>
                                    <a href="#">Service Bot</a>
                                </li>
                                <li>
