...
<title>Press Release |Facilitate Industry 4.0</title>
...
<div class="page-wrapper">
 ...
 <div class="main">
                ...
                <div class="row align-items-center">
                    <div class="col-md-9 col-lg-7">
                        <div class="page-header-content text-white pt-4">
                            <h1 class="text-white mb-0">Press Release 17-08-2021</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
        <div class="d-flex mt-4"><a href="{{ route('home') }}">Home</a><p>-></p><a href="{{ route('pressrelease') }}">Press Release</a><p>-></p><a href="{{ route('pressrelease.press2') }}">Press 2</a></div>
            <div class="row">
                <div class="col-12 press">
                    <div class="press02">
                        <iframe src="https://www.youtube.com/embed/Rlku6f3AsJI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        ...
                        <blockquote class="sidekick">
                         The project has been a great opportunity for the Bangladeshi teams to raise their startup competitiveness to the next level. I am confident that all teams will continue the journey of great challenges to grow as a next generation leader in Bangladeshi’s ICT field.<cite>Zunaid Ahmed Palak. MP, State Minister, Bangladesh's ICT Division</cite>
                        </blockquote><br><br>
                       <p>&emsp;&emsp;&emsp;
    ...
    <!--our team section start-->
        <section class="client-section  ptb3-100">
            <div class="container">
