                ...
                <div class="row align-items-center">
                    <div class="col-md-9 col-lg-7">
                        <div class="page-header-content text-white pt-4">
                            <h1 class="text-white mb-0">Press Release 12-08-2021</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 press">
                    <div class="">
                       ...
                       <blockquote class="sidekick">
                        ...
                        <br><br>
                        <blockquote class="sidekick">
                         Our experiential learning approach enables students to apply their STEAM (Science, Technology, Engineering, Arts & Mathematics) learnings on real-life hardware modules via our DIY modular learning kits and/or learn coding through our gamified learning solutions. This consolidates their technical competency while fostering design thinking and innovation. Based on our growth, we are planning to raise the next round of funds and build partnerships. Since, it is a new element in modern education, we would be glad if anyone reaches out to us which can help us refurbish our product and service lines, we are all ears.<cite> Thajid Ibna Uday, CEO</cite>
                        </blockquote><br><br>
