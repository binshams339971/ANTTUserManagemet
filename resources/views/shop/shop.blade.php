...
<title>Shop | Facilitate Industry 4.0 | ANTT Robotics Ltd.</title>
...
<div class="page-wrapper">
 ...
 @include('layout.header')
    ...
    <section>
        <div class="container">
          <h1 class="title font-weight-bold text-center">EduBlock -</h1>
          <h2 class="font-weight-bold text-center">Coding Learning Robot for 5+ years Kids</h2>
          <br>
          <div class="row">
            ...
            <div class="col-lg-6 col-12 text-center">
              ...
              <ul class="check-list-wrap text-left">
                ...
                <li>Do yourself Code and make 100 of projects like Soccer Robot, Line follower, Distance Measurement Robot and so on.</li>
                <li>Learn Graphical programming, C programming, Python using EduBlock.</li>
                <li>Interactive Course Curriculum for Individual Education Level beside STEAM Method.</li>
                <li>Code, Control, Implement using Mobile Phone using Edublock App. </li>
            ...
            <div class="d-flex">
              ...
              <a href="{{ route('shop.edublock') }}" class="btn btn-outline-brand-02">Learn More</a>
            </div>
              <div class="action-btns mt-4 px-4">
                <!-- <a href="#" target="_blank" class="btn btn-brand-02 mr-3">Start Now</a> -->
    ...
    <section>
            ...
            <div class="row">
              <div class="col-lg-6 col-12 text-center">
                ...
                <div class="d-flex">
                  <div class="action-btns mt-4 px-4">
                    <!-- <a href="#" target="_blank" class="btn btn-brand-02 mr-3">Start Now</a> -->
                    <a href="{{ route('shop.schoolofiot') }}" class="btn btn-outline-brand-02">Learn More</a>
                  </div>
        ...
        <section class="position-relative feature-section ptb4-100">
            <div class="container">
                <div class="row align-items-center justify-content-between justify-content-sm-center justify-content-md-center">
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="feature-contents">
                            <h2>Robots to Blossom the Inventive Heads of Tomorrow</h2>
    ...
    <!--our team section start-->
        <section class="client-section  ptb5-100">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="section-heading text-center mb-5">
                            ...
                            <p>
                                Trusted & Supported by Governments & Private Stakeholders
                            </p>
                        </div>
                    </div>
                </div>
