...
<title>Terms and Conditions | Facilitate Industry 4.0</title>
    ...
    <div class="bg-white rounded-lg shadow py-3 mb-4">
        <div class="col-sm-12 my-4">
            ...
            <ol class="mx-md-5 ml-4 mr-2 text-left" style="list-style-type: decimal;">
                ...
                <p>These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website located at <a href="{{ route('refund-policy') }}">www.anttrobotics.com</a> operated by ANTT Robotics Ltd. .</p>
                ...
                <li>Refunds</li>
                <p>Please refer to our <a href="{{ route('refund-policy') }}">Refund and Return Policy</a> for further details.</p>
                ...
                <ol class="ml-5 text-left" style="list-style-type: lower-alpha;">
