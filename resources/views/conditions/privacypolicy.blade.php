...
<title>Privacy Policy | Facilitate Industry 4.0</title>
                    ...
                    <div class="navbar-nav nav-start" id="navstart">
                       <a class="d-none d-lg-block" href="{{ route('home') }}"><img src="https://edublock.co/anttaset/ANTTRobotics_logo_full%20white-04.png" alt="logo" class="nav-img"></a>
                        ...
                        <ul class="nav navbar-nav m-auto nav-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="https://docs.google.com/forms/d/e/1FAIpQLSci6KOi_qauHE5HabXakyF3UFPjDFgCITHJH92v4vrTh4qtfg/viewform" target="_blank" class="page-scroll">Sign Up</a>
                            </li>
                        </ul>                
