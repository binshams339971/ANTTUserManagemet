...
<title>Refund Policy | Facilitate Industry 4.0</title>
...
<div class="container" style="margin-top: 100px;">
    <div class="bg-white rounded-lg shadow p-md-5 my-3">
        <div class="col-sm-12 my-4 text-left">
            <h1 class="text-center">Refund Policy</h1><br>
            
            <h3 class="text-secondary">Interpretation and Definitions</h3>
            <hr>
            <h5>Interpretation</h5>
            <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
            <h5>Definitions</h5>
            <p>For the purposes of this Return and Refund Policy:</p>
            <ul class="text-left" style="list-style-type: disc; margin-left: 50px;">
                <li><p>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to ANTT Robotics Ltd. , Level-04, Software Technology Park, 49, Janata Tower Karwan Bazar, Dhaka- 1215, Bangladesh.</p></li>
                <li><p>Goods refer to the items offered for sale on the Service.</p></li>
                <li><p>Orders mean a request by You to purchase Goods from Us</p></li>
                <li><p>Service refers to the Website.</p></li>
                <li><p>Website refers to ANTT Robotics Ltd. , accessible from https://www.anttrobotics.com</p></li>
            ...
            <h3 class="text-secondary">Your Order Cancellation Right</h3><hr>
            ...
            <ul style="list-style-type: disc; margin-left: 20px;"><li><p>By email: anttrobotics@gmail.com</p></li></ul>
            <p>We will reimburse You no later than 14 days from the day on which We receive the returned Goods. We will use the same means of payment as You used for the Order, and You will not incur any fees for such reimbursement.</p>
            
            <h3 class="text-secondary">Conditions for Returns</h3><hr>
            <p>In order for the Goods to be eligible for a return, please make sure that:</p>
            <ul style="list-style-type: disc; margin-left: 20px;">
                <li><p>The Goods were purchased in the last 14 days</p></li>
                <li><p>The Goods are in the original packaging</p></li>
            </ul>
            <p>The following Goods cannot be returned:</p>
            <ul style="list-style-type: disc; margin-left: 20px;">
                <li><p>The supply of Goods made to Your specifications or clearly personalized.</p></li>
                <li><p>The supply of Goods which according to their nature are not suitable to be returned, deteriorate rapidly or where the date of expiry is over.</p></li>
                <li><p>The supply of Goods which are not suitable for return due to health protection or hygiene reasons and were unsealed after delivery.</p></li>
                <li><p>The supply of Goods which are, after delivery, according to their nature, inseparably mixed with other items.</p></li>
            </ul>
            <p>We reserve the right to refuse returns of any merchandise that does not meet the above return conditions in our sole discretion.</p>
            <p>Only regular priced Goods may be refunded. Unfortunately, Goods on sale cannot be refunded. This exclusion may not apply to You if it is not permitted by applicable law.</p>
            
            <h3 class="text-secondary">Returning Goods</h3><hr>
            <p>You are responsible for the cost and risk of returning the Goods to Us. You should send the Goods at the following address: <br>ANTT Robotics LTd, Level-04, Software Technology Park, 49, Janata Tower, Karwan Bazar, Dhaka- 1215, Bangladesh</p>
            <p>We cannot be held responsible for Goods damaged or lost in return shipment. Therefore, We recommend an insured and trackable mail service. We are unable to issue a refund without actual receipt of the Goods or proof of received return delivery.</p>
        
            <h3 class="text-secondary">Gifts</h3><hr>
