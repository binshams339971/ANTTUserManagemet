...
class SslCommerzPaymentController extends Controller
{
    ...
    {
        return view('exampleHosted')->with('orderid', $request->orderid)
                                    ...
                                    ->with('postcode', $request->postcode);
    }
    ...
    public function index(Request $request)
    {
        ...
        $post_data['cus_orderid'] = $request->orderid;
        $post_data['cus_price'] = $request->price;
        ...
        $post_data['cus_add2'] = "";
        $post_data['cus_city'] = $request->customer_state;
        ...
        $update_product = DB::table('payments')
            ...
            ->updateOrInsert([
                ...
                'order_id' => $post_data['cus_orderid'],
    ...
    public function success(Request $request)
    {
        ...
        $order = DB::table('order_models')
                    ->where('id', $order_detials->order_id)
                    ->update(['status' => 'Paid', 'transaction_id' => $order_detials->transaction_id]);
        $request->session()->put('pay-success', "1");
    ...
    public function fail(Request $request)
    {
        ...
        $request->session()->put('pay-fail', "0");
        return redirect('/user/order');
    ...
    public function cancel(Request $request)
    {
        ...
        $request->session()->put('pay-cancel', "0");
        return redirect('/user/order');
